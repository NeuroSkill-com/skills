...
| [neuroskill-screenshots](skills/neuroskill-screenshots/SKILL.md) | screenshot/OCR search context | `search-images` and `screenshots-around` commands — search screenshots by OCR text (semantic or substring mode) and find screenshots near a specific timestamp. CLIP vision embedding and OCR indexing. |
