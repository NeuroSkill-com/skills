...
| [neuroskill-terminal](skills/neuroskill-activity/SKILL.md) | terminal/shell/command tracking | `terminal` command — OS-wide shell hook management (install/uninstall/status for zsh/bash/fish/PowerShell), tracked terminal commands, brain-fused terminal impact analysis, dev loop detection, context switch cost. |
...
| [neuroskill-calendar](skills/neuroskill-calendar/SKILL.md) | calendar/schedule/meetings/events questions | `calendar` command — OS calendar events via EventKit (macOS), iCal files (Linux/Windows); fetch by range, check access status, request permission. |
...
| [neuroskill-protocols-focus](skills/neuroskill-protocols-focus/SKILL.md) | focus, attention, cognitive load, energy, alertness, flow, creativity | Focus, attention, cognition, consciousness, and energy/alertness protocols. |
| [neuroskill-protocols-meditation](skills/neuroskill-protocols-meditation/SKILL.md) | meditation, mantra, visualization, loving-kindness, body scan, open awareness, neurofeedback meditation | Meditation protocols — focused attention, open monitoring, mantra, visualization, loving-kindness, body scan, walking meditation, and EEG-biofeedback meditation. |
| [neuroskill-protocols-mindfulness](skills/neuroskill-protocols-mindfulness/SKILL.md) | mindfulness, present-moment awareness, noting, RAIN, STOP, grounding, urge surfing, mindful eating, thought defusion | Mindfulness protocols — noting, mindful breathing/eating/walking/listening, STOP, RAIN, 5-4-3-2-1 grounding, thought defusion, self-compassion, equanimity, and urge surfing. |
